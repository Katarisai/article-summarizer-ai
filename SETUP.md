...
- `backend/models/Summary.js` - Summary schema
- `backend/controllers/summaryController.js` - Business logic with OpenAI integration
- `backend/routes/summaryRoutes.js` - API routes
- `backend/package.json` - Backend dependencies (express, mongoose, openai, cors, dotenv)
...
| CORS errors | Backend CORS is configured, ensure proxy in frontend/package.json |
